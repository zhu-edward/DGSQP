...
from DGSQP.dynamics.dynamics_models import CasadiKinematicBicycleProgressAugmented, CasadiDecoupledMultiAgentDynamicsModel
...
def get_approximate_dynamic_game(args):
    # Initial time
    t = 0
    ...
    car1_dynamics_config = KinematicBicycleConfig(dt=dt,
                                                ...
                                                code_gen=False,
                                                M=M)
    car1_pa_dyn_model = CasadiKinematicBicycleProgressAugmented(t, car1_dynamics_config, track=track_obj)
    ...
    car2_dynamics_config = KinematicBicycleConfig(dt=dt,
                                                ...
                                                code_gen=False,
                                                M=M)
    car2_pa_dyn_model = CasadiKinematicBicycleProgressAugmented(t, car2_dynamics_config, track=track_obj)
